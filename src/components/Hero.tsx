...
import { ArrowDown, Users, TrendingUp, Building } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <div className="bg-gray-800 bg-opacity-70 p-4 rounded-lg flex items-center">
              <TrendingUp className="text-purple-400 mr-3" />
              <span className="text-white">Analytics Engineer</span>
            </div>
            <div className="bg-gray-800 bg-opacity-70 p-4 rounded-lg flex items-center">
              <Building className="text-green-400 mr-3" />
              <span className="text-white">Data Architect</span>
            </div>
          </div>
          <button 
