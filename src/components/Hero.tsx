...
const Hero: React.FC = () => {
  ...
  const startGuidedAnimation = () => {
    ...
    // Phase 2: Subtitle appears (after 1500ms - slower)
    setTimeout(() => {
      setAnimationPhase(2);
    }, 1500);
    
    // Phase 3: Skills pills appear (after 2800ms - slower)
    setTimeout(() => {
      setAnimationPhase(3);
    }, 2800);
    
    // Phase 4: Button appears (after 4200ms - slower)
    setTimeout(() => {
      setAnimationPhase(4);
    }, 4200);
  };
  ...
  return (
    <div id="home" className="min-h-screen bg-gray-950 relative flex items-center">
      {/* Background image - always visible from the start */}
      <div 
        className="absolute inset-0 opacity-15 bg-cover bg-center transition-opacity duration-1000"
        style={{
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl mx-auto text-center">
          {/* Phase 1: Main Title - slower, more elegant entrance */}
          <h1 
            ref={titleRef} 
          ...
          {/* Phase 2: Subtitle - slower, more graceful */}
          <p 
            className={`text-xl md:text-2xl text-gray-300 mb-8 transition-all duration-1200 ease-out transform ${
              animationPhase >= 2 
          ...
          {/* Phase 3: Skills Pills - slower staggered animation */}
          ...
          {/* Phase 4: Call to Action Button - elegant final entrance */}
          <button 
