          ...
          <div className="relative group">
            ...
            {!isInteractionEnabled && (
              <div className="absolute inset-0 z-20 rounded-lg pointer-events-none">
                {/* Clickable area - only on hover to preserve scrolling */}
                <div 
                  className="absolute inset-0 cursor-pointer pointer-events-none group-hover:pointer-events-auto"
                  onClick={enableInteraction}
                />
                
                {/* Visual overlay that appears on hover */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-lg flex items-center justify-center pointer-events-none">
                ...
                {/* Corner indicator - always visible and clickable */}
                <div 
                  className="absolute top-4 right-4 bg-gray-900/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg text-sm border border-gray-600 flex items-center cursor-pointer hover:bg-gray-800 transition-colors pointer-events-auto"
                  onClick={enableInteraction}
                >
                  <Scroll size={16} className="mr-2 text-blue-400" />
                  <span className="text-gray-300">Scroll Mode - Click to Interact</span>
                </div>
              </div>
            )}
