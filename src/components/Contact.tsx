            ...
            <div className="bg-gray-700 rounded-lg p-6 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <Mail className="text-indigo-400 mt-1 mr-4" />
                  <div>
                    <h4 className="text-white font-medium">Email</h4>
                    <p className="text-gray-300">contact@datascientist.com</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Phone className="text-indigo-400 mt-1 mr-4" />
                  <div>
                ...
                <div className="flex items-start">
                  <MapPin className="text-indigo-400 mt-1 mr-4" />
                  <div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((link, index) => {
                    ...
                    const IconComponent = {
                      'github': () => <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-indigo-600 transition-colors">G</div>,
                      'linkedin': () => <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-indigo-600 transition-colors">L</div>,
                      'twitter': () => <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-indigo-600 transition-colors">T</div>,
                      'book-open': () => <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-indigo-600 transition-colors">M</div>
                    }[link.icon] || (() => <div>?</div>);
