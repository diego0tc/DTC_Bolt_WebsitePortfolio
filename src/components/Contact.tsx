...
import { Send, Linkedin, Github, ArrowRight, ExternalLink, MessageSquare, Calendar } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  return (
    <div id="contact" className="py-20 bg-gray-800 relative">
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center mb-12">
          ...
          <button
            onClick={() => navigate('/contact')}
            className="ml-4 group text-green-400 hover:text-green-300 transition-colors"
            title="View detailed contact options"
          >
        ...
        <div className="md:flex md:space-x-10">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <div className="bg-gray-700 rounded-lg p-6 h-full relative">
              {/* More options indicator */}
              <button
                onClick={() => navigate('/contact')}
                className="absolute top-4 right-4 group bg-gray-600/50 hover:bg-green-600 rounded-full p-2 transition-all duration-300"
                title="View collaboration types & availability"
              >
              ...
              {/* Teaser for more contact options */}
              <div className="mt-6 p-4 bg-green-900/20 rounded-lg border border-green-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-green-200 text-sm font-medium">Need more options?</p>
                    <p className="text-green-300 text-xs">Response times, availability & collaboration types</p>
                  </div>
                  <button
                    onClick={() => navigate('/contact')}
          ...
          <div className="md:w-1/2">
            <div className="bg-gray-700 rounded-lg p-6 relative">
              ...
              <button
                onClick={() => navigate('/contact')}
                className="absolute top-4 right-4 group bg-gray-600/50 hover:bg-green-600 rounded-full p-2 transition-all duration-300"
                title="Enhanced contact form with project types"
              >
                <Calendar size={16} className="text-gray-400 group-hover:text-white group-hover:rotate-12 transition-all duration-300" />
              </button>
              ...
              {/* Enhanced form teaser */}
              <div className="mt-6 p-4 bg-green-900/20 rounded-lg border border-green-700/30">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-green-200 text-sm font-medium">Need a more detailed form?</p>
                    <p className="text-green-300 text-xs">Project types, timeline & collaboration preferences</p>
                  </div>
                  <button
                    onClick={() => navigate('/contact')}
                    className="text-green-400 hover:text-green-300 transition-colors"
