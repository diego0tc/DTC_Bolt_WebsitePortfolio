      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <div className="text-3xl font-bold text-indigo-400 mb-2">{projectStats.total}</div>
            <div className="text-gray-300">Total Projects</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <div className="text-3xl font-bold text-blue-400 mb-2">{projectStats.tableau}</div>
            <div className="text-gray-300">Tableau Dashboards</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <div className="text-3xl font-bold text-green-400 mb-2">{projectStats.python}</div>
            <div className="text-gray-300">Python Projects</div>
          </div>
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <div className="text-3xl font-bold text-purple-400 mb-2">{projectStats.analysis}</div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white focus:border-indigo-500 focus:outline-none"
              />
            </div>
            ...
            <div className="flex gap-4 items-center">
              ...
              <select
                ...
                className="bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-white focus:border-indigo-500 focus:outline-none"
              >
        ...
        {/* Call to Action */}
        <div className="mt-16 bg-gradient-to-r from-indigo-900/30 to-purple-900/30 rounded-xl p-8 border border-indigo-700/30 text-center">
